...
const addNewVolunteerPosting = (
  ...
  return db
    .query(
      `INSERT INTO volunteer_board (name, description, status, location, cause, creation_date, start_date, end_date, volunteers_needed) VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9) RETURNING *`,
      [
        name,
        description,
        status,
...
module.exports = {
  ...
  getAllUserVolunteerPositions,
  getVolunteerCount,
  deleteVolunteerFromPosition,
  addVolunteerFromPosition,
